package com.example.geesyscrm.utilities;
...
public class Session
{
	...
	public static String PREFERENCE_EVENT_PURCHASE="preference_event_purchase";
	...
	/*public void setLogin(User user){
		...
		edit.putString(PREFERENCE_WALLET,user.getWallet());
		edit.putString(PREFERENCE_EVENT_PURCHASE,user.getEvent_joined());
		edit.putString(PREFERENCE_LOGIN_PROFILE_PATH,""+user.getProfile_pic());
		edit.apply();
	}*/
/*public User getLogin(){
		User user=new User();
		user.setUserid(file.getString(PREFERENCE_LOGIN_ID,""));
		...
		user.setWallet(file.getString(PREFERENCE_WALLET, ""));
		user.setEvent_joined(file.getString(PREFERENCE_EVENT_PURCHASE, ""));
